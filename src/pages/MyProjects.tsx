...
const MyProjects = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-electric-blue-50 to-smart-purple-50 p-3 sm:p-4 lg:p-6">
        ...
        <Card className="glass-card">
          <CardHeader className="p-4 sm:p-6">
            <div className="flex items-center justify-between gap-4">
              ...
              <CardTitle className="text-lg sm:text-2xl bg-gradient-to-r from-electric-blue-600 to-smart-purple-600 bg-clip-text text-transparent text-center">
                I Miei Progetti
              </CardTitle>
              <Button
                onClick={() => navigate('/create-project')}
                className="bg-gradient-to-r from-electric-blue-500 to-smart-purple-500 hover:from-electric-blue-600 hover:to-smart-purple-600 text-xs sm:text-sm px-2 sm:px-4 shrink-0"
                size="sm"
              >
        ...
        <div className="space-y-4 lg:hidden">
          ...
          <Card className="glass-card">
            <CardHeader className="p-4">
              <CardTitle className="text-base">I Tuoi Progetti</CardTitle>
            </CardHeader>
